...
export default function Anasayfa() {
  ...
  return (
    ...
    <h3 title="Neden Karbel?" id="neden_karbel?" className={styles.heading}> Neden Karbel ? </h3>
    
    <hr/>
        <div className={styles.grid_container}>
    <div className={styles.grid_item}>
    <div  className={styles.icon}><i className={"fas fa-hourglass fa-3x"} ></i></div>
    ...
    <div className={styles.grid_item} >
    <div  className={styles.icon}> <i className={"fas fa-chart-bar fa-3x"} ></i> </div>
    ...
    <div className={styles.grid_item}>
    <div className={styles.icon}> <i className={"fas fa-users fa-3x"} ></i> </div>
    ...
    <div className={styles.grid_item} >
    <div className={styles.icon}> <i className={"fas fa-laptop fa-3x"} ></i> </div>
    ...
    <div className={styles.grid_item} >
    <div className={styles.icon}> <i className={"fas fa-chess-rook fa-3x"} ></i> </div>
    <h3 title="Güvenirlik" id="güvenirlik" >Güvenilirlik</h3>
    <p> Güvenirlik, şeffaflık ve açıklık. </p>
    </div>

    <div className={styles.grid_item} >
    <div className={styles.icon}> <i className={"fas fa-leaf fa-3x"} ></i> </div>
